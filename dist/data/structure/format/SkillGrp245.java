...
public class SkillGrp245 implements FormatListener
{
	...
	public String decode(ActionTask actionTask, double progressWeight, String str)
	{
		...
		while (m3.find())
		{
			...
			iconPanels2.computeIfAbsent(skillId, _ -> new HashMap<>()).put(getSkillLevelMask(skillLvl, skillSubLvl), iconPanel2);
	...
	public String encode(ActionTask actionTask, double progressWeight, String str)
	{
		...
		while (m2.find())
		{
			...
			{
				iconPanels2.computeIfAbsent(id, _ -> new LinkedHashMap<>()).put(getSkillLevelMask(level, sublevel), iconPanel2);
			}
